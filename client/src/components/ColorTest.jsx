...
const ColorTest = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        style={{ ...boxStyle, backgroundColor: `rgb(${colors[0].join(",")})` }}
      />
      <div
        style={{ ...boxStyle, backgroundColor: `rgb(${colors[1].join(",")})` }}
      />
      <div
        style={{ ...boxStyle, backgroundColor: `rgb(${colors[2].join(",")})` }}
      />
    </div>
  );
};
