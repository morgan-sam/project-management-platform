  ...
  const menus = [
    ...
    },
    {
      ...
      sub: [
        {
          name: `${
            checkIfAllTasksSelected(rawTaskList, selectedTasks) ? "S" : "Des"
          }elect All`,
          action: () => selectAllTasks(),
        },
        {
          name: `Mark ${
            checkIfAllSelectedAreComplete(rawTaskList, selectedTasks)
              ? "Inc"
              : "C"
          }omplete`,
          action: () => {
      ...
      sub: [
        {
          ...
          sub: [
            ...
            {
              name: `${
                Object.values(displayedBars).includes(true) ? "Close" : "Open"
              } All`,
              action: () => {
          ...
          sub: [
            {
              ...
              action: () => setVisibleColumns(visibleColumnsDefault),
            },
