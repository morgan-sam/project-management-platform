...
export const parseDateObjToISO = (obj) => {
  const dayString =
    obj.day >= 10 ? obj.day.toString() : "0" + obj.day.toString();
  const monthString =
    obj.month >= 10 ? obj.month.toString() : "0" + obj.month.toString();
...
export const parseECMADateToDateObj = (ECMADate) => {
  return {
    day: ECMADate.getDate(),
    month: ECMADate.getMonth() + 1,
    year: ECMADate.getFullYear(),
  };
};
